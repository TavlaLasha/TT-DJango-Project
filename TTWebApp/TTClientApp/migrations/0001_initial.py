    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payment', models.CharField(db_column='Payment', max_length=50)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('productname', models.CharField(db_column='ProductName', max_length=80)),
                ('picture', models.CharField(db_column='Picture', max_length=255)),
                ('price', models.FloatField(db_column='Price', max_length=50, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('attributevalue', models.CharField(db_column='AttributeValue', max_length=70)),
            ],
            options={
        ...
        migrations.CreateModel(
            name='Customers',
            fields=[
                ('customer', models.AutoField(db_column='CustomerID', primary_key=True, serialize=False)),
                ('username', models.CharField(db_column='UserName', max_length=50, unique=True)),
                ('firstname', models.CharField(db_column='FirstName', max_length=50)),
                ('lastname', models.CharField(db_column='LastName', max_length=50)),
                ('email', models.EmailField(db_column='Email', max_length=60, unique=True, verbose_name='email')),
                ...
                ('date_joined', models.DateField(auto_now_add=True, db_column='date_joined')),
                ('last_login', models.DateField(auto_now=True, db_column='last_login')),
